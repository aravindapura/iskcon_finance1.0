                  ...
                  >
                    <div
                      style={{
                        ...
                        borderRadius: "1.1rem",
                        background:
                          "linear-gradient(145deg, rgba(15, 23, 42, 0.92), rgba(30, 64, 175, 0.35))",
                        border: "1px solid rgba(59, 130, 246, 0.35)",
                        boxShadow: "0 20px 36px -30px rgba(37, 99, 235, 0.78)"
                      }}
                    >
                      <div
                        style={{
                            ...
                            return (
                              <button
                                ...
                                style={{
                                  ...
                                  textAlign: "center",
                                  boxShadow: isActive
                                    ? "0 10px 20px -18px rgba(59, 130, 246, 0.65)"
                                    : "0 5px 12px -18px rgba(15, 23, 42, 0.45)",
                                  transition:
