                ...
                >
                  <label
                    style={{
                      ...
                      borderRadius: "1rem",
                      background:
                        "linear-gradient(135deg, rgba(59, 130, 246, 0.16), rgba(14, 165, 233, 0.12))",
                      border: "1px solid rgba(59, 130, 246, 0.25)",
                      boxShadow: "0 18px 32px -28px rgba(37, 99, 235, 0.95)"
                    }}
                  >
                    <span
                      style={{
                    ...
                    >
                      <span
                        ...
                        style={{
                          ...
                          boxShadow: "0 10px 20px -16px rgba(37, 99, 235, 0.8)"
                        }}
                      >
                        {amountCurrencyLabel}
                      </span>
                    ...
                    >
                      Введите положительное значение, чтобы сохранить операцию.
                    </span>
                  </label>
                            ...
                            return (
                              <button
                                ...
                                style={{
                                  ...
                                  border: isActive
                                    ? "2px solid var(--accent-primary, rgba(59, 130, 246, 0.75))"
                                  ...
                                  textAlign: "center",
                                  boxShadow: isActive
                                    ? "0 10px 18px -16px rgba(59, 130, 246, 0.65)"
                                    : "0 6px 14px -18px rgba(15, 23, 42, 0.4)",
                                  transition:
                                    "background-color 0.2s ease, transform 0.18s ease, border-color 0.2s ease"
                                }}
                              >
                                <span
                                  aria-hidden
