              ...
              {formType ? (
                <form
                  ...
                  style={{
                    ...
                    boxShadow: "0 28px 55px -35px rgba(15, 23, 42, 0.65)"
                  }}
                >
                  <label
                    style={{
                  ...
                  >
                    <div
                      style={{
                        ...
                        background:
                          "linear-gradient(160deg, rgba(30, 41, 59, 0.88), rgba(15, 23, 42, 0.75))",
                    ...
                    >
                      ...
                      <input
                        ...
                        style={{
                          ...
                          boxShadow: "0 8px 22px -18px rgba(59, 130, 246, 0.75)",
                            ...
                            return (
                              <button
                                ...
                                style={{
                                  ...
                                  textAlign: "center",
                                  boxShadow: isActive
                                    ? "0 12px 28px -22px rgba(59, 130, 246, 0.65)"
                                    : "0 6px 16px -18px rgba(15, 23, 42, 0.55)",
                                  transition:
